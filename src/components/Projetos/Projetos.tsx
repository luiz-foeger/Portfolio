                ...
                <div className="relative z-10 flex flex-col md:flex-row h-full gap-4 md:gap-10 items-center">
                    ...
                    <div className="w-full md:w-[45%] flex flex-col justify-between h-full py-4 z-20 order-2 md:order-1">
                        <div>
                            ...
                            <p className="text-sm md:text-lg text-white/80 leading-relaxed mb-4 md:mb-8">{description}</p>                        </div>
                    ...
                    {/* LADO DIREITO */}
                    <div className="w-full md:w-[55%] flex-1 md:h-full min-h-[200px] rounded-2xl overflow-hidden relative border border-white/10 z-10 bg-black/50 order-1 md:order-2 shadow-xl">
...
const Projetos = () => {
    ...
    return (
        <section ref={container} id="projetos" className="relative mt-32 mb-32">
            ...
            {/* --- AMBIENT LIGHT (Opcional, mas recomendado) --- */}
            {/* Uma luz azul sutil atrás dos cards para o vidro ter o que refletir */}
            ...
            <div className="max-w-[1000px] mx-auto px-6 mb-24 relative z-10">
                ...
                <motion.p className="text-white/90 text-sm sm:text-base md:text-2xl leading-relaxed">
